...
public class GithubCommit extends TableImpl<GithubCommitRecord> {
    ...
    /**
     * The column <code>GITHUB_COMMIT.REPO_ID</code>.
     */
    public final TableField<GithubCommitRecord, Long> REPO_ID = createField(DSL.name("REPO_ID"), SQLDataType.BIGINT, this, "");

    /**
     * The column <code>GITHUB_COMMIT.AUTHOR</code>.
     */
    public final TableField<GithubCommitRecord, String> AUTHOR = createField(DSL.name("AUTHOR"), SQLDataType.VARCHAR(1000000000).nullable(false), this, "");

    /**
     * The column <code>GITHUB_COMMIT.CREATED_AT</code>.
     */
    public final TableField<GithubCommitRecord, OffsetDateTime> CREATED_AT = createField(DSL.name("CREATED_AT"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false), this, "");
    ...
    public List<ForeignKey<GithubCommitRecord, ?>> getReferences() {
        return Arrays.asList(Keys.CONSTRAINT_2B9);
    }
    ...
    public GithubRepository githubRepository() {
        if (_githubRepository == null)
            _githubRepository = new GithubRepository(this, Keys.CONSTRAINT_2B9);
     ...
     */
    public <U> SelectField<U> mapping(Function4<? super String, ? super Long, ? super String, ? super OffsetDateTime, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function4<? super String, ? super Long, ? super String, ? super OffsetDateTime, ? extends U> from) {
