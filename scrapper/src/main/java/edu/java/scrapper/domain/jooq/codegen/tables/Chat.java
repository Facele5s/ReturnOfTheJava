...
public class Chat extends TableImpl<ChatRecord> {
    ...
    /**
     * The column <code>CHAT.REGISTRATION_DATE</code>.
     */
    public final TableField<ChatRecord, OffsetDateTime> REGISTRATION_DATE = createField(DSL.name("REGISTRATION_DATE"), SQLDataType.TIMESTAMPWITHTIMEZONE(6), this, "");
